...
OUT_ROOT=${OUT_ROOT:-/data/dj/MapEcho/artifacts/phase1_7_location_selection_pilot/model_scoring_pilot}
...
/home/dj/.conda/envs/maptr/bin/python scripts/run_ccs_location_scoring_pilot.py \
